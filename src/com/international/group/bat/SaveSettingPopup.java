...
//QUERY CONFIGURATIONS
	...
	public static String key605 = "cb_QueryConfigurations_MonitoringModeSettings_enabled";
	public static String key606 = "cb_QueryConfigurations_MonitoringModeSettings_checked";
//USER SETTINGS
	//0) CURRENT PIN
	...
	//11) LABEL SETTINGS
	public static String key607 = "cbLabelSettings_enabled";
	public static String key608 = "cbLabelSettings_checked";
	public static String key609 = "cbLabelSettingsDisabled_enabled";
	public static String key610 = "cbLabelSettingsDisabled_checked";
	public static String key611 = "sbLabelSettings_enabled";
	public static String key612 = "sbLabelSettings_value";
	public static String key613 = "etLabelSettings_enabled";
	public static String key614 = "etLabelSettings_value";
	//12) SMS MONITORING ARMING
	public static String key615 = "cbSMSMonitoringArming_enabled";
	public static String key616 = "cbSMSMonitoringArming_checked";
	public static String key617 = "spinSMSMonitoringArming_enabled";
	public static String key618 = "spinSMSMonitoringArming_value";
//INPUTS
	//IN1
...
//TIMERS
	...
	//Turbotimer
	public static String key619 = "cbTurboTimerSettings_enabled";
	public static String key620 = "cbTurboTimerSettings_checked";
	public static String key621 = "et_TurbotimerWorkingTime_enabled";
	public static String key622 = "et_TurbotimerWorkingTime_value";
	public static String key623 = "et_IngnTimeLockedEngine_enabled";
	public static String key624 = "et_IngnTimeLockedEngine_value";
    //Starttimer
    public static String key625 = "cbStarttimer_enabled";
    public static String key626 = "cbStarttimer_checked";
    public static String key627 = "et_Starttimer_enabled";
    public static String key628 = "et_Starttimer_value";
	//Armtimer
	public static String key629 = "cbArmtimer_enabled";
	public static String key630 = "cbArmtimer_checked";
	public static String key631 = "et_Armtimer_enabled";
	public static String key632 = "et_Armtimer_value";
...
//QUERY CONFIGURATIONS
		...
		//4.Monitoring mode setting
		settings += "<"+ key605 +">" + MainActivity.stateholderQueryConfigurations.getCbMonitoringModeSettingsEnabled() + "</"+ key605 +">\n";
		settings += "<"+ key606 +">" + MainActivity.stateholderQueryConfigurations.getCbMonitoringModeSettingsChecked() + "</"+ key606 +">\n";
//USER SETTINGS
		//0) CURRENT PIN
		...
		//11) LABEL SETTINGS
		settings += "<"+ key607 +">" + MainActivity.stateholderUserSettings.getCbLabelSettingsEnabled() + "</"+ key607 +">\n";
		settings += "<"+ key608 +">" + MainActivity.stateholderUserSettings.getCbLabelSettingsChecked() + "</"+ key608 +">\n";
		settings += "<"+ key609 +">" + MainActivity.stateholderUserSettings.getCbLabelSettingsDisabledEnabled() + "</"+ key609 +">\n";
		settings += "<"+ key610 +">" + MainActivity.stateholderUserSettings.getCbLabelSettingsDisabledChecked() + "</"+ key610 +">\n";
		settings += "<"+ key611 +">" + MainActivity.stateholderUserSettings.getSbLabelSettingsEnabled() + "</"+ key611 +">\n";
		settings += "<"+ key612 +">" + MainActivity.stateholderUserSettings.getSbLabelSettingsValue() + "</"+ key612 +">\n";
		settings += "<"+ key613 +">" + MainActivity.stateholderUserSettings.getEtLabelSettingsEnabled() + "</"+ key613 +">\n";
		settings += "<"+ key614 +">" + MainActivity.stateholderUserSettings.getEtLabelSettingsValue() + "</"+ key614 +">\n";
		// SMS REPORTING ARMING
		settings += "<"+ key615 +">" + MainActivity.stateholderUserSettings.getCbSMSReportingArmingEnabled() + "</"+ key615 +">\n";
		settings += "<"+ key616 +">" + MainActivity.stateholderUserSettings.getCbSMSReportingArmingChecked() + "</"+ key616 +">\n";
		settings += "<"+ key617 +">" + MainActivity.stateholderUserSettings.getSMSReportingArmingEnabled() + "</"+ key617 +">\n";
		settings += "<"+ key618 +">" + MainActivity.stateholderUserSettings.getSMSReportingArmingValue() + "</"+ key618 +">\n";
//INPUTS
		//IN1
...
//TIMERS
        ...
        //Turbotimer
        settings += "<"+ key619 +">" + MainActivity.stateholderTimer.getCbTurboTimerSettingsEnabled() + "</"+ key619 +">\n";
        settings += "<"+ key620 +">" + MainActivity.stateholderTimer.getCbTurboTimerSettingsChecked() + "</"+ key620 +">\n";
        settings += "<"+ key621 +">" + MainActivity.stateholderTimer.getTurbotimerWorkingTimeEnabled() + "</"+ key621 +">\n";
        settings += "<"+ key622 +">" + MainActivity.stateholderTimer.getTurbotimerWorkingTimeValue() + "</"+ key622 +">\n";
        settings += "<"+ key623 +">" + MainActivity.stateholderTimer.getIngnTimeLockedEngineEnabled() + "</"+ key623 +">\n";
        settings += "<"+ key624 +">" + MainActivity.stateholderTimer.getIngnTimeLockedEngineValue() + "</"+ key624 +">\n";
        //Starttimer
        settings += "<"+ key625 +">" + MainActivity.stateholderTimer.getCbStarttimerEnabled() + "</"+ key625 +">\n";
        settings += "<"+ key626 +">" + MainActivity.stateholderTimer.getCbStarttimerChecked() + "</"+ key626 +">\n";
        settings += "<"+ key627 +">" + MainActivity.stateholderTimer.getStarttimerEnabled() + "</"+ key627 +">\n";
        settings += "<"+ key628 +">" + MainActivity.stateholderTimer.getStarttimerValue() + "</"+ key628 +">\n";
        //Armtimer
        settings += "<"+ key629 +">" + MainActivity.stateholderTimer.getCbArmtimerEnabled() + "</"+ key629 +">\n";
        settings += "<"+ key630 +">" + MainActivity.stateholderTimer.getCbArmtimerChecked() + "</"+ key630 +">\n";
        settings += "<"+ key631 +">" + MainActivity.stateholderTimer.getArmtimerEnabled() + "</"+ key631 +">\n";
        settings += "<"+ key632 +">" + MainActivity.stateholderTimer.getArmtimerValue() + "</"+ key632 +">\n";
		//OutputTimerOnArmDelay
