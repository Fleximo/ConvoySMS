...
public class GeneratorTimer 
{
	...
	public Map<String, String> getGeneratedMap()
	{
		...
		m_generatedMap.put(TextSMS.TIMER_STARTTIMER, getStarttimer());
        m_generatedMap.put(TextSMS.TIMER_ARMTIMER, getArmtimer());
...
//Turbotimer
	...
	{
		if(m_stateholder.getCbTurboTimerSettingsChecked())
		{
...
//Starttimer
	...
	{
		if(m_stateholder.getCbStarttimerChecked())
		{
			String code = "STARTTIMER ";

			code += Integer.valueOf(m_stateholder.getStarttimerValue())*4 + " ";
...
//Armtimer
    private String getArmtimer()
    {
        if(m_stateholder.getCbArmtimerChecked())
        {
            String code = "ARMTIMER ";

            code += (m_stateholder.getArmtimerValue()) + " ";
