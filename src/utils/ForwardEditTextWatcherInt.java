...
public class ForwardEditTextWatcherInt implements TextWatcher
{
	String m_lastValue = "";
	...
	public ForwardEditTextWatcherInt(EditText editText)
	{
		super();
		m_editText = editText;
	}

	public ForwardEditTextWatcherInt(EditText editText, SeekBar seekbar, String defaultValue, String minValue, String maxValue)
	{
		super();
		m_editText = editText;
	...
	public void afterTextChanged(Editable s) 
	{
		...
		try 
		{
			...
			if(m_seekBar != null)
				m_seekBar.setProgress(IntegerValue - m_minValue);
	    } 
		catch (NumberFormatException e) 
	    {
			value = "";
			if(m_seekBar != null)
				m_seekBar.setProgress(Integer.valueOf(m_defaultValue - m_minValue));
	    }
